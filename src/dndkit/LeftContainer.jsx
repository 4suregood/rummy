...
export default function LeftContainer(props) {
    // console.log('Render LeftContainer props=', props);
    ...
    // console.log('[LeftContainer] heightNo=', heightNo);
    let height = maxHeight * 0.7;
    if (height > 300) {
        height = 300;
    }
    console.log('[LeftContainer] height=', height);
    ...
    return (
        <div ref={elementRef} style={containerStyle}>
            ...
            <h5 style={playerStyle}>Left player</h5>
        </div>
    );
}
