...
// const PlayingCard = ({ id, rank, suit, points }) => {

//   return (
//     <img key={id} src={`{rank}_of_{suit}`} alt={id} />
//   );
// };
          ...
          <p>
            <a href="https://github.com/STRML/react-draggable/blob/master/example/example.js">Demo Source</a>
                ...
                <Draggable {...dragHandlers}>
                    <div className="box">
                    <img key={this.props.card.id} src={images(this.props.card.imageSrc)} width={width} alt={this.props.card.imageSrc} />
                    </div>
                </Draggable>
